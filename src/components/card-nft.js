...
export function CardNFT ({ thumbnail, name, value, value_brl }) {
    return (
        <div className="w-full max-w-card-nft overflow-hidden rounded-2xl 
        border border-gray-border-card bg-gray-area-favorite">
            ...
            <div className="relative w-full h-area-image-nft overflow-hidden">
                ...
                py-3 px-6 bg-gray-area-favorite rounded-full border border-gray-border-card'>
                    <Image 
                    src={IconHeart}
                    alt='Icon Heart'
                    />
            ...
            <div className='w-full p-4'>
                ...
                <div className='flex items-end justify-between mb-4'>
                    <div className='space-y-1 '>
                        ...
                        <h3 className='flex items-center gap-1 text-lg font-semibold'><Image src={IconETH}  alt='Icon ETH'/>{value} BTC</h3> 
                    </div>
                ...
                <button className='w-full py-4 bg-blue-primary rounded-full mb-4 text-sm 
                font-semibold hover:bg-blue-600 transition-all ease-linear'>Buy Now</button>
                <div className='flex items-center gap-1'>
                    <Image src={IconClock} alt='Icon Clock' />
                    <p className='text-xs'>Fim em 4h 8m 23s</p>
